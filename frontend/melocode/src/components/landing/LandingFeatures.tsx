...
export function LandingFeatures() {
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 gap-6 divide-y-2 divide-[var(--gray-6)]">
        {features.map(({ icon: Icon, image, title, description }) => (
          ...
          >
            <img
              src={image}
              alt=""
              className="aspect-[16/9] border border-[var(--gray-8)] rounded-md w-2/3 shrink-0 object-cover max-sm:w-full"
            />
