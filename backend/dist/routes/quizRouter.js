...
quizRouter.get("/:quizAnswerId/test-cases", quizController.getQuizTestCasesInputs);
quizRouter.use(mandatoryVerifyToken);
quizRouter.post("/:quizAnswerId/submissions", quizController.saveQuizSubmission);
